...
from transformations import treating_missings, standardize_stats, standardize_data
...
#         df_test_scaled = scaled_data['test_data']
        to_stand = [c for c in df_train.columns if ('L#' in c)]
        stats = standardize_stats(df_train, to_stand)
    ...
    if standardize:
        return df_train, df_test, df_train_scaled, df_test_scaled, stats
    else:
        return df_train, df_test, df_train_scaled, df_test_scaled, None
